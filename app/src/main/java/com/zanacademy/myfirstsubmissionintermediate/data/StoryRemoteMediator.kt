...
import com.zanacademy.myfirstsubmissionintermediate.data.entity.RemoteKeys
        ...
        try {
            ...
            database.withTransaction {
                if (loadType == LoadType.REFRESH) {
                    ...
                    database.storyItemDao().deleteAll()
                }
                ...
                database.storyItemDao().insertStory(responseData.listStory)
            }
